...
class M161109073613Create_group_table extends Migration
{
    public function safeUp()
    {
        ...
        $this->createTable('{{%group}}', [
            ...
            'billing_cycle' => $this->smallInteger(5)->unsigned()->defaultValue(0)->comment('Billing Cycle'),
            'days_free' => $this->smallInteger(5)->unsigned()->defaultValue(0)->comment('Days Free'),
